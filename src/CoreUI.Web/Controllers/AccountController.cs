...
namespace CoreUI.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        // visualizar la vista para registrar
        [HttpGet]
        [AllowAnonymous]
        ...
        // envia datos al modelo para regisyrar nuevo usuario
        [HttpPost]
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        await _userManager.AddToRoleAsync(user, "AdminUsuario");
                        await _signInManager.SignInAsync(user, isPersistent: false);
                        _logger.LogInformation("User created a new account with password.");
                    ...
                    xrol = await _roleManager.RoleExistsAsync("AdminUsuario");
                    if (!xrol)
                    {
                        var role = new IdentityRole();
                        role.Name = "AdminUsuario";
